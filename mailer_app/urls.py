...
urlpatterns = [
    ...
    path('media/manage/', views.manage_media_assets, name='manage_media_assets'), # NEW
    path('media/asset/<uuid:asset_id>/delete/', views.delete_media_asset, name='delete_media_asset'), # NEW
