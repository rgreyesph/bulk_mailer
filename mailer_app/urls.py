...
urlpatterns = [
    ...
    path('track/click/<uuid:log_id_str>/<path:original_url_encoded>/', views.track_click, name='track_click'),
    path('resubscribe/', views.resubscribe_contact_view, name='resubscribe_contact'),
